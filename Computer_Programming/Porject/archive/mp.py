...
class main_page(search):
    ...
    def create_page(self):
        ...
        for i in range(6):
            b = ctk.CTkButton(self.root, width=450 , height= 300 , text = f"Car{i + 1}", command= self.make_page,).grid(row = 1 + i//3, column = i % 3, pady = 10,padx = 10)
    def on_search(self):
        from archive.sp import sp
